export const SITE_NAME = 'Lens & Light';
export const SITE_DESCRIPTION = 'Professional Photography Equipment Store';
...
export const TRUST_BADGES = [
  ...
  },
  {
    ...
    description: 'Official brand protection',
  },
  {
    icon: 'support_agent',
    title: 'Expert Support',
    description: '24/7 Professional advice',
  },
  {
    icon: 'lock',
